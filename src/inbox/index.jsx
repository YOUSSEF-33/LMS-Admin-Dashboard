										...
										<div className="row">
											<div className="col top-action-left">
												<div className="float-right">
													<div className="btn-group dropdown-action">
														<button type="button" className="btn btn-white dropdown-toggle ms-1" data-bs-toggle="dropdown">Select <i className="fas fa-angle-down"></i></button>
													...
													<div className="btn-group dropdown-action">
														<button type="button" className="btn btn-white dropdown-toggle ms-1" data-bs-toggle="dropdown">Actions <i className="fas fa-angle-down"></i></button>
														<div className="dropdown-menu">
													...
													<div className="btn-group dropdown-action">
														<button type="button" className="btn btn-white dropdown-toggle ms-1" data-bs-toggle="dropdown"><i className="fas fa-folder"></i> <i className="fas fa-angle-down"></i></button>
													...
													<div className="btn-group dropdown-action">
														<button type="button" data-bs-toggle="dropdown" className="btn btn-white dropdown-toggle ms-1"><i className="fas fa-tags"></i> <i className="fas fa-angle-down"></i></button>
														<div role="menu" className="dropdown-menu">
											...
											<div className="col-auto top-action-right">
												<div className="text-start">
													<button type="button" title="Refresh" data-bs-toggle="tooltip" className="btn btn-white d-none d-md-inline-block ms-1"><i className="fas fa-sync-alt"></i></button>
