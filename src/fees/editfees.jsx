										...
										<div className="row">
											...
											<div className="col-12 col-sm-6">
												<div className="form-group">
													...
													<input type="text" className="form-control" defaultValue="$152"/>
												</div>
											</div>
											<div className="col-12 col-sm-6">
												<div className="form-group">
													<label>Start Date</label>
													<input type="text" className="form-control" defaultValue="23 Apr 2020"/>
												</div>
											</div>
											<div className="col-12 col-sm-6">
												<div className="form-group">
													<label>End Date</label>
													<input type="text" className="form-control" defaultValue="28 Apr 2020"/>
												</div>
											</div>
											<div className="col-12">
