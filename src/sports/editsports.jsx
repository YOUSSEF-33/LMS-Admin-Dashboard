										...
										<div className="row">
											...
											<div className="col-12 col-sm-6">
												<div className="form-group">
													...
													<input type="text" className="form-control" defaultValue="Hockey"/>
												</div>
											</div>
											<div className="col-12 col-sm-6">  
												<div className="form-group">
													<label>Coach Name</label>
													<input type="text" className="form-control" defaultValue="Joseph"/>
												</div>
											</div>
											<div className="col-12 col-sm-6">
												<div className="form-group">
													<label>Started Year</label>
													<input type="text" className="form-control" defaultValue="2005"/>
												</div>
											</div>
											<div className="col-12">
