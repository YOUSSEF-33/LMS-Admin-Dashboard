										...
										<div className="row">
											...
											<div className="col-12 col-sm-6">
												<div className="form-group">
													...
													<input type="text" className="form-control" defaultValue="MCA"/>
												</div>
											</div>
											<div className="col-12 col-sm-6">
												<div className="form-group">
													<label>Head of Department</label>
													<input type="text" className="form-control" defaultValue="Lois A"/>
												</div>
											</div>
											<div className="col-12 col-sm-6">
												<div className="form-group">
													<label>Department Start Date</label>
													<input type="text" className="form-control" defaultValue="1992"/>
												</div>
											</div>
											<div className="col-12 col-sm-6">
												<div className="form-group">
