...
const AddQuiz = () => {
    ...
    const validateForm = () => {
        ...
        formData.questions.forEach((question, index) => {
            ...
            if ((question.type === 'ONE_CHOICE' || question.type === 'TWO_CHOICES') && question.options.length < 2) {
                newErrors[`question_${index}_options`] = "يجب إضافة خيارين على الأقل";
            }
            if (question.answers.length === 0 && (question.type === 'ONE_CHOICE' || question.type === 'TWO_CHOICES')) {
                newErrors[`question_${index}_answer`] = "يجب اختيار إجابة واحدة على الأقل";
            }
            if (question.type === 'TWO_CHOICES' && question.answers.length < 2) {
                newErrors[`question_${index}_answer`] = "يجب اختيار إجابتين على الأقل";
            }
        });
    ...
    const handleSubmit = async (e) => {
        ...
        formData.questions.forEach((question, index) => {
            ...
            // File attachments for all question types
        ...
        try {
            await axiosInstance.post(`v1/admin/courses/${courseId}/course-content-categories/${categoryId}/quizzes`, formDataToSend, {
                headers: {
                    'Content-Type': 'multipart/form-data'
                }
            });
            message.success("تمت إضافة الاختبار بنجاح");
            navigate(-1);
        } catch (error) {
            console.error("Error creating quiz:", error);
            message.error("حدث خطأ أثناء إنشاء الاختبار");
        }
    };
                    ...
                    <div className="row align-items-center">
                        <div className="col-sm-12">
                            <div className="page-sub-header">
                                <h3 className="page-title">إضافة اختبار</h3>
                                <ul className="breadcrumb">
                                    <li className="breadcrumb-item">
                                        <Link to="/quizzes">الاختبارات</Link>
                                    </li>
                                    <li className="breadcrumb-item active">إضافة اختبار</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-12 col-sm-6">
                                            <div className="form-group local-forms">
                                                ...
                                                <DatePicker
                                                    ...
                                                    onChange={(date) => handleDateChange('dead_line', date)}
                                                />
                                        ...
                                        {formData.questions.map((question, index) => (
                                            <div key={index} className="col-12 border p-3 mb-3">
                                                <div className="row">
                                                    ...
                                                    {(question.type === 'FILES' || question.type === 'ONE_CHOICE' || question.type === 'TWO_CHOICES' || question.type === 'TEXT') && (
                                        ...
                                        <div className="col-12">
                                            <div className="student-submit">
                                                <button type="submit" className="btn btn-primary">إضافة الاختبار</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
