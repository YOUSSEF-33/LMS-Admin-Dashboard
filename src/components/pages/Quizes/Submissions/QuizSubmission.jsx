...
const SubmissionDetails = () => {
    const { id, courseId, categoryId, quizId, submissionId } = useParams();
    const facultyId = id;
    ...
    const fetchSubmissionDetails = async () => {
        setLoading(true);
        try {
            const response = await axiosInstance.get(`v1/admin/courses/${courseId}/course-content-categories/${categoryId}/quizzes/${quizId}/submissions/${submissionId}`);
    ...
    const navigateToSubmission = (submissionId) => {
        navigate(`/admin/faculties/${facultyId}/courses/${courseId}/categories/${categoryId}/quizzes/${quizId}/submissions/${submissionId}`);
    };
    ...
    const handleSubmit = async () => {
        try {
            ...
            await axiosInstance.patch(`v1/admin/courses/${courseId}/course-content-categories/${categoryId}/quizzes/${quizId}/submissions/${submissionId}`);
