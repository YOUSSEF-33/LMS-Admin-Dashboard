...
const ListCategory = () => {
    ...
    const fetchData = async (page, limit) => {
        ...
        try {
            const response = await axiosInstance.get(`v1/admin/courses/content-categories?limit=${limit}&page=${page}`);
    ...
    const handleDelete = (id) => {
        Modal.confirm({
            ...
            onOk: async () => {
                try {
                    await axiosInstance.delete(`v1/courses/content-categories/${id}`);
